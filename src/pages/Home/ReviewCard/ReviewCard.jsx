    ...
    return (
        <div className={style.ReviewCard}>
            {reviewData.map((review) => (
                (
                    <ReviewItem key={review.id} name={review.name} description={review.description} rating={review.rating} />
                )
            ))}
        </div>
    )
